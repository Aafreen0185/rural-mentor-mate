...
const SignInModal = ({ isOpen, onClose }: SignInModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-gradient-card border-sage-green/30">
        <DialogHeader className="text-center">
          ...
          <p className="text-muted-foreground">Sign in to your RuralReach account</p>
        </DialogHeader>
        ...
        <form onSubmit={handleSignIn} className="space-y-6">
          ...
          <div className="text-right">
            <button
              type="button"
              className="text-sm text-forest-green hover:text-warm-gold transition-smooth"
            >
        ...
        <div className="space-y-4">
          <Separator className="bg-sage-green/30" />
          
          {/* Social Sign In */}
          <div className="space-y-3">
            <Button variant="outline" className="w-full border-sage-green/30 hover:bg-sage-green/10">
